---
description: Capture a task with metadata
---
> This command delegates to `.uteuk/prompts/task-capture.md`.
...
→ See `.uteuk/prompts/task-capture.md` for full instructions.

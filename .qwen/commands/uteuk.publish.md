---
description: Convert draft to Ghost-ready blog post
---
> This command delegates to `.uteuk/prompts/publish.md`.
...
→ See `.uteuk/prompts/publish.md` for full instructions.
